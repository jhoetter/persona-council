...
STRINGS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "no_projects": "Noch keine Projekte. Lege eines an oder backfille deine Reports (CLI: research-backfill).", "themes_h": "Themen",
        ...
        "prototypes_teach": "Scaffolde einen klickbaren Prototyp aus einem Konzept (scaffold_prototype).", "sessions_teach": "Lass eine Persona einen Prototyp wirklich benutzen (record_usability_session, record_prototype_session).",
        ...
        "chip_steps_n": "{n} Schritte", "chip_steps_n_one": "{n} Schritt",
        ...
        # opt-in product tour (ticket opt-in-product-tour) — chrome + the six steps
        "tour_take": "Tour starten",
        "tour_restart": "Tour neu starten",
        "tour_offer": "Neu hier? Nimm die 60-Sekunden-Tour.",
        "tour_dismiss": "Ausblenden",
        "tour_next": "Weiter", "tour_back": "Zurück",
        "tour_skip": "Überspringen", "tour_done": "Fertig",
        "tour_projects_h": "Alles beginnt mit einem Projekt",
        "tour_projects_d": "Jede Forschungsfrage lebt in einem Projekt — Councils, Reports, Prototypen und Notizen hängen als ein Graph daran.",
        "tour_personas_h": "Personas sind deine Stimmen",
        "tour_personas_d": "Synthetische Kundenprofile mit simuliertem Gedächtnis — je tiefer ihr gelebtes Leben, desto besser ihre Antworten.",
        "tour_library_h": "Die Bibliothek: alles Produzierte",
        "tour_library_d": "Councils, Reports, Prototypen, Sessions, Umfragen, Hypothesen, Entscheidungen, Notizen — ein Browser, acht Tabs.",
        "tour_activity_h": "Aktivität: was gerade passiert",
        "tour_activity_d": "Der Live-Feed aller aufgezeichneten Ereignisse — sieh zu, wie die Forschung entsteht.",
        "tour_cmdk_h": "Überall hinspringen",
        "tour_cmdk_d": "⌘K öffnet die Befehlspalette: Suche über Projekte, Personas, Councils — plus alle Sprungbefehle.",
    ...
    "en": {
        ...
        "no_projects": "No projects yet. Create one or backfill your reports (CLI: research-backfill).", "themes_h": "Themes",
        ...
        "prototypes_teach": "Scaffold a clickable prototype from a concept (scaffold_prototype).", "sessions_teach": "Have a persona actually use a prototype (record_usability_session, record_prototype_session).",
        ...
        "chip_steps_n": "{n} steps", "chip_steps_n_one": "{n} step",
        ...
        "tour_offer": "New here? Take the 60-second tour.",
        "tour_dismiss": "Dismiss",
        "tour_next": "Next", "tour_back": "Back",
        "tour_skip": "Skip", "tour_done": "Done",
        "tour_projects_h": "Everything starts with a project",
        "tour_projects_d": "Every research question lives in a project — councils, reports, prototypes and notes hang off it as one graph.",
        "tour_personas_h": "Personas are your voices",
        "tour_personas_d": "Synthetic customer profiles with simulated memory — the deeper their lived lives, the better their answers.",
        "tour_library_h": "The Library: everything produced",
        "tour_library_d": "Councils, reports, prototypes, sessions, surveys, hypotheses, decisions, notes — one browser, eight tabs.",
        "tour_activity_h": "Activity: what's happening now",
        "tour_activity_d": "The live feed of every recorded event — watch the research come together.",
        "tour_cmdk_h": "Jump anywhere",
        "tour_cmdk_d": "⌘K opens the command palette: search across projects, personas, councils — plus every jump command.",
