...
STRINGS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "tour_councils_h": "Councils: die Debatte",
        "tour_councils_d": "Mehrere Personas reagieren auf eine Frage oder These — geerdet in ihrer Erfahrung, nicht im Wunschdenken.",
        "tour_syntheses_h": "Reports fassen es zusammen",
        "tour_syntheses_d": "Strukturierte, zitierfähige Antworten über die ganze Forschung — jederzeit exportierbar.",
    ...
    "en": {
        ...
        "tour_councils_h": "Councils: the debate",
        "tour_councils_d": "Several personas react to a question or thesis — grounded in their experience, not in wishful thinking.",
        "tour_syntheses_h": "Reports pull it together",
        "tour_syntheses_d": "Structured, citable answers across the whole research — exportable any time.",
