...
STRINGS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "kbd_list_open": "Fokussierte Zeile öffnen",
        "kbd_sib_prev": "Vorheriger Eintrag", "kbd_sib_next": "Nächster Eintrag",
        "kbd_close_overlays": "Overlays schließen",
        ...
        "delete_project": "Projekt löschen", "delete_persona": "Persona löschen",
        ...
        "delete_confirm_q": "Wirklich löschen? Das kann nicht rückgängig gemacht werden.",
    ...
    "en": {
        ...
        "kbd_list_open": "Open focused row",
        "kbd_sib_prev": "Previous record", "kbd_sib_next": "Next record",
        "kbd_close_overlays": "Close overlays",
        # first-steps checklist on the empty-DB home (ticket one-sentence-mcp-install)
        ...
        "delete_project": "Delete project", "delete_persona": "Delete persona",
        ...
        "delete_confirm_q": "Really delete? This cannot be undone.",
