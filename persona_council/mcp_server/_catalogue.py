...
grouped by its module's domain. Exposed as the `persona-council://guide/catalogue` resource.
"""
...
def catalogue_md() -> str:
    ...
    lines = [
        ...
        "",
        "Start with the **`persona-council://guide/research`** resource for the canonical path "
